...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-pages-users-users-module"], {
  ...
  /***/
  function srcAppComponentsPagesUsersUsersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsPagesUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _home_search_search_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    function UsersComponent_ng_container_8_div_41_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var UsersComponent = /*#__PURE__*/function () {
      function UsersComponent(UsersService, activateRouter, router) {
      ...
      _createClass(UsersComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.getDataFromService();
        }
      }, {
        ...
        value: function getDataFromService() {
          ...
          var params = this.activateRouter.snapshot.params;
          this.start = 0;
          this.repos = 0;

          if (params.id) {
            this.UsersService.searchUsers(params.id).subscribe(function (res) {
              //console.log(res);
              _this.user = res;
            }, function (err) {
          ...
          this.UsersService.searchRepoUsers(params.id).subscribe(function (res) {
            console.log(res);
            _this.repoUser2 = res;
            _this.repoUser = _this.repoUser2.sort(function (a, b) {
              return b.stargazers_count - a.stargazers_count;
            });

            _this.sumValues();

            _this.varError = false;
          }, function (err) {
            console.log(err);
            _this.varError = true;
          });
        ...
        value: function sumValues() {
          ...
          this.repoUser.forEach(function (element) {
            _this3.start += element.stargazers_count;
            _this3.repos += 1; //console.log(this.start)
    ...
    UsersComponent.ɵfac = function UsersComponent_Factory(t) {
      return new (t || UsersComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]));
    };
    ...
    UsersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_home_search_search_component__WEBPACK_IMPORTED_MODULE_4__["SearchComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"]],
  ...
  /***/
  function srcAppComponentsPagesUsersUsersModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    UsersModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _users_routing_module__WEBPACK_IMPORTED_MODULE_2__["UsersRoutingModule"], _home_home_module__WEBPACK_IMPORTED_MODULE_4__["HomeModule"]]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UsersModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _users_routing_module__WEBPACK_IMPORTED_MODULE_2__["UsersRoutingModule"], _home_home_module__WEBPACK_IMPORTED_MODULE_4__["HomeModule"]],
        exports: [_users_component__WEBPACK_IMPORTED_MODULE_3__["UsersComponent"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppComponentsServicesUsersServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var UsersService = /*#__PURE__*/function () {
      ...
      _createClass(UsersService, [{
        ...
        value: function searchUsers(value) {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrlAPI, "/").concat(value));
        }
      }, {
        key: "searchRepoUsers",
        value: function searchRepoUsers(value) {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrlAPI, "/").concat(value, "/repos"));
        }
      }]);
...
//# sourceMappingURL=components-pages-users-users-module-es5.js.map